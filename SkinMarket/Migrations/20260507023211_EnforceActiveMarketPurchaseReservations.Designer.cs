...
namespace SkinMarket.Migrations
{
    ...
    [Migration("20260507023211_EnforceActiveMarketPurchaseReservations")]
    partial class EnforceActiveMarketPurchaseReservations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkinMarket.Models.PriceSnapshot", b =>
                {
                    ...
                    b.Property<decimal?>("BestAskUsd")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");

                    b.Property<decimal?>("BestBidUsd")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<DateTime?>("FxObservedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("SkinMarket.Models.SteamInventoryCacheEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SteamId", "AppId", "ContextId")
                        .IsUnique();
